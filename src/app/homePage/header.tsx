...
const Header = () => {
    ...
    return (
        <div className="flex justify-end w-[98%] 3xl:w-full gap-14 items-center py-12 pb-6 max-lg:hidden laptop-hidden"  id='portfolio'>
            ...
            <div className="flex gap-4 text-white bg-blur-background border rounded-lg border-sky-500/35 p-5 3xl:text-2xl">
                <a className='cursor-pointer hover:text-sky-500 transition-all duration-400 ease-in-out' href='https://github.com/asal1922'>Github</a>
