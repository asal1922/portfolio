...
import { AdditiveBlending, Vector3, BufferGeometry, Group } from "three";
import * as THREE from "three";
import { useFrame } from "@react-three/fiber";
import { useMainStore } from "../../../store/zustand/main";

const NeuralNetwork = () => {
    const { fadeOut } = useMainStore();
    ...
    const particlesData = useMemo(() => [] as { velocity: Vector3; numConnections: number }[], []);
